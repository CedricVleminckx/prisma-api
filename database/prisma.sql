...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 16 jul 2018 om 15:46
...
CREATE TABLE `users` (
  ...
  `family_id` varchar(5) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` (`id`, `email`, `password`, `first_name`, `last_name`, `profile_pic`, `remember_token`, `created_at`, `updated_at`, `user_type`, `last_login`, `family_id`, `slug`) VALUES
(1, 'noreply@prisma.care', '$2y$10$3m6J/gmsCZIUZYAfRjK9t.ho0gBmnFHG0KUAh97AMc5.I1X6EoqBy', 'Prisma', 'System', NULL, NULL, '2018-07-16 07:53:37', '2018-07-16 07:53:37', 'family', NULL, NULL, NULL);
